...
import { Card, CardImg, CardTitle, Form, Input, InputGroup, Button } from "reactstrap";
...
const StaffList = (props) => {
  ...
  // Duyệt ds nhân viên
  const staff = searchStaff.staff.map((staff) => {
    return (
      ...
      <div className="container">
        <div key={props.id} className="row">
          <div className="row col-12 col-md-6 col-lg-5">
            <h3 className="staff col-10">Nhân Viên</h3>
